...
#
# Copied verbatim from probes/depth/dinov3_depth/models/dpt_head.py so this probe stays
# self-contained (same reason losses.py / metrics.py were copied): the dinov3_depth
# package __init__ imports the external ``dinov3.eval`` package, which is not importable
# here. This module only depends on torch.
