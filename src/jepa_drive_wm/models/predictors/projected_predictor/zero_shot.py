...
if __name__ == "__main__":
    ...
    from jepa_drive_wm.models.predictors.projected_predictor.warp_rgb import WarpModule

    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    H, W = 384, 1248
    SEQ_NR, SOURCE_ID, FUTURE_ID = 9, 375, 380  # same clip as the projected-predictor experiments

    # Warp the source frame to the future view (same settings as the projected-predictor experiments).
