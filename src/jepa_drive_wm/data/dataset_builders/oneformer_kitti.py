...
Entry points:
  ...
  viz        -- visualise one frame's saved segmentation, both as the raw 19
    ...
    python -m jepa_drive_wm.data.dataset_builders.oneformer_kitti build-all
    python -m jepa_drive_wm.data.dataset_builders.oneformer_kitti build --seq 10
    python -m jepa_drive_wm.data.dataset_builders.oneformer_kitti viz   --seq 10 --frame 0
